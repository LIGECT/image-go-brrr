...
class Carousel {
  constructor(containerSelector, options = {}) {
    ...
    this.strip.addEventListener('transitionend', this.boundTransitionEndHandler);
  ...
  setupArrows() {
    this.arrowPrev = this.createBlock('button', 'carousel-arrow carousel-arrow--prev');
    this.arrowNext = this.createBlock('button', 'carousel-arrow carousel-arrow--next');
  ...
  destroy() {
    ...
    if (this.strip && this.boundTransitionEndHandler) {
      this.strip.removeEventListener('transitionend', this.boundTransitionEndHandler);
    }
    if (this.container) {
    ...
    if (this.dotsContainer && this.boundDotsClickHandler) {
      this.dotsContainer.removeEventListener('click', this.boundDotsClickHandler);
    }
    this.container = null;
    this.strip = null;
    this.frame = null;
